    ...
    <main id="main" class="display_flex_center">
      <div class="main_content_wrapper">
		...
		<?php
			...
			$row = $query->fetch();
			$view = $db->query("update Epilogue set view=view+1 where num= '$num'");
		?>
          ...
          <section id="section_container" class="section_write_review">
            ...
            <div class="btn_area right">
						<!--<button type="submit" onclick="javascript: form.action='http://www.covac.news/checkpw.php';"
						class="btn_write_4_1">수정</button>-->
